      ...
      <template v-else>
        <div class="share-panel">
          ...
          <div class="share-op-btn">
            <el-button v-if="shareInfo.currentUser"
              type="primary"
              @click="cancelShare"
          ...
          >
            <template #fileName="{ index, row }">
              ...
              >
                ...
                <span class="op">
                  <span v-if="row.folderType == 0" class="iconfont icon-download" @click="download(row.fileId)">下载</span>
...
const getShareInfo = async () => {
  ...
  if (result.data == null) {//未输入验证码信息，返回结果为null，跳转到shareCheck页面
